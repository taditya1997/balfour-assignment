...
function LoginPage() {
  ...
  const { setIsLoggedIn, userCred } = useAppContext();
   ...
   *it states the username and password from the localstorage and compare it with the user input.
   **/
  const handleLogin = async () => {
    const passwordFromLocalStorage = localStorage.getItem("password");

    if (
      (username === userCred.user && password === userCred.password) ||
      (username === userCred.user && password === passwordFromLocalStorage)
    ) {
